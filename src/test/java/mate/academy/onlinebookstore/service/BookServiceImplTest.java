...
class BookServiceImplTest {
    ...
    void findAll_WithTwoBooks_ReturnTwoBooks() {
        ...
        assertEquals(firstBookDto.getTitle(), actual.get(0).getTitle());
        assertEquals(secondBookDto.getTitle(), actual.get(1).getTitle());
    }
    ...
    void findAllByCategory_WithValidCategoryId_ReturnBookWithoutCategoryIdDto() {
        ...
        assertEquals(1, actual.size());
        assertEquals(FIRST_BOOK_TITLE, actual.get(0).title());
    }
